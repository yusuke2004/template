...
ActiveRecord::Schema[7.2].define(version: 2025_07_03_095806) do
  ...
  create_table "postag_tag_relations", force: :cascade do |t|
    ...
    t.index ["tag_id"], name: "index_postag_tag_relations_on_tag_id"
  end

  create_table "postags", force: :cascade do |t|
    t.string "title"
    t.string "body"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "postag_tag_relations", "postags"
  add_foreign_key "postag_tag_relations", "tags"
end
